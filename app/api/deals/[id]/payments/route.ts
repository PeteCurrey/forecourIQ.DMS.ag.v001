...
export async function GET(
  ...
  try {
    ...
    const payments = await PaymentService.listByDeal(profile.dealership_id, params.id)
...
export async function POST(
  ...
  try {
    ...
    const payment = await PaymentService.record(profile.dealership_id, params.id, user.id, body)
